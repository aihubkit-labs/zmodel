...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/video_capability_templates", permission: authz.ChannelRead, handler: controller.ListVideoModelCapabilityTemplates},
	{method: http.MethodPost, path: "/video_capability_templates", permission: authz.ChannelWrite, handler: controller.SaveVideoModelCapabilityTemplate},
	{method: http.MethodDelete, path: "/video_capability_templates/:id", permission: authz.ChannelWrite, handler: controller.DeleteVideoModelCapabilityTemplate},
