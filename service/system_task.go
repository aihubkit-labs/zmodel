...
// EnqueueSystemTaskWithKey deduplicates an on-demand task by a caller-provided
// active key while keeping execution serialized by task type.
func EnqueueSystemTaskWithKey(taskType string, activeKey string, payload any) (*model.SystemTask, bool, error) {
