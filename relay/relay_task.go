...
func RelayTaskSubmit(c *gin.Context, info *relaycommon.RelayInfo) (*TaskSubmitResult, *dto.TaskError) {
	...
	if err != nil {
		return nil, service.TaskErrorWrapperLocal(err, "invalid_billing_dimensions", http.StatusBadRequest)
	}
	priceData, err := helper.ModelPriceHelperMedia(c, info, mediaDimensions)
	if err != nil {
