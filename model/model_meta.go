...
type Model struct {
	...
	UsageGuidelines string         `json:"usage_guidelines,omitempty" gorm:"type:text"`
...
func (mi *Model) Update() error {
	...
	return DB.Model(&Model{}).Where("id = ?", mi.Id).
		Select("model_name", "description", "usage_guidelines", "icon", "tags", "vendor_id", "endpoints", "status", "sync_official", "name_rule", "updated_time").
		Updates(mi).Error
}
